        ...
        <b>Давайте знакомиться!</b>
          <div className='O-nas-vseh'>
            <div className='O-nas'>
              ...
              Увлекается программированием и качалкой.
            </div>
            <div className='O-nas'>
            <img src={dima} className="Photo" alt="dima" srcset="" draggable="false"/>
              ...
              Лучший футболист по мнению популярного издания "МИИГАиК_news".<br/>
              Знает и владеет абсолютно всеми видами спорта.<br/>
              Обучит вас правильно играть в шашки на Ярославском шоссе.<br/>
              Любимая цитата - "За что мы все любим футбол? За то, что после него..."<br/>
              Увлекается программированием и суетологией.
            </div>
            <div className='O-nas'>
              ...
              Увлекается программированием и укреплением здоровья <br/>по особой методике пивной диеты.
            </div>
          </div>
        </div>
      </div>
