        ...
        <div className="team-personal">
          ...
          <div className='O-nas-vseh'>
            <div className='O-nas'>
              ...
              <b>Тихонин Сергей</b><br/>Чемпион Мира по литрболу<br/>Главные достоинства:<br/>
              ...
              Любимая цитата - "Зал - моя любовь"<br/>
              Увлекается програмированием и качалкой
            </div>
            <div className='O-nas'>
            <img src={dima} className="Photo" alt="dima" srcset="" draggable="false"/>
              <b>Чуреев Дмитрий</b><br/>Мастер спорта по всем видам спорта<br/>Главные достоинства:<br/>
            ...
            <div className='O-nas'>
              ...
              <b>Забелло Егор</b><br/>Пивной сенсей<br/>Главные достоинства:<br/>
              ...
              Любимая цитата - "Сил в пиве и нашем тренажерном зале "Hanma Gym"<br/>
